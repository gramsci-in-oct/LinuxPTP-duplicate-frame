					 ...
					 int id, struct ptp_message *req)
{
	...
	if (respond)
		port_prepare_and_send(p, rsp, TRANS_GENERAL,0);
	msg_put(rsp);
	return respond;
}
...
/*丢弃过大的offset，实际操作先等待频率偏移<10000然后停止，接着趁机编译就稳定了*/
//	if(offset>100000){printf("offset_before fil:%li\n",offset);
//			
//			if(offset>400000&offset<5000000){offset=0000;}
//			else{
//				
//					if(offset>100000&offset<200000){offset=75000+offset/4;}
//					else{offset=100000+offset/10;}}}
//	if(offset<-100000){printf("offset_before fil:%li\n",offset);
//			if(offset<-400000&offset>-5000000){offset=-0000;}
//			else{
//	
...
/*					else{offset=-100000+offset/10;}}}
	offset=offset*0.2;
*/	
	c->master_offset=nanoseconds_to_tmv(offset);
//	}	
